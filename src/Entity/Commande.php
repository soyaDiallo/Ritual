...
class Commande
{
    ...
    public function getDateLancement(): ?int
    {
        return $this->dateLancement;
    }

    public function setDateLancement(int $dateLancement): self
    {
    ...
    public function getDateAnnulation(): ?int
    {
        return $this->dateAnnulation;
    }

    public function setDateAnnulation(int $dateAnnulation): self
    {
